...
function dayservice_ikoi_excerpt_more($more) {
    return '...';
}
add_filter('excerpt_more', 'dayservice_ikoi_excerpt_more');

function dayservice_ikoi_excerpt_length($length) {
    return 100;
}
add_filter('excerpt_length', 'dayservice_ikoi_excerpt_length');