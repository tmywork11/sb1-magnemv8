...
export default function NewsItem({ date, category, title, link }: NewsItemType) {
  return (
    <a
      href={link}
      className="flex items-center space-x-6 py-4 px-4 border-b border-gray-100 hover:bg-gray-50 rounded-lg transition-all duration-200 group"
    >
